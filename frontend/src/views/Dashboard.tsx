    ...
    <div>
      <div style={{ paddingTop: '20px' }}>
        ...
        {alert && (
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: isSmallScreen ? 'nowrap' : 'wrap'  }}>
            <Typography variant="h4" style={{margin:'auto'}}>My Dashboard</Typography>
              <span style={{margin:'auto'}}>Hello {username}!</span>
